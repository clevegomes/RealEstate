...
function the_bootstrap_register_scripts_styles() {
	...
	if ( ! is_admin() ) {
        ...
        wp_register_script(
            'jquery.scrollUp.min',
            get_template_directory_uri() . "/js/jquery.scrollUp.min.js",
            array(),
            '',
            true
        );
        ...
        wp_register_script(
            'price-range',
            get_template_directory_uri() . "/js/price-range.js",
            array(),
            '',
            true
        );
		...
		wp_register_script(
			...
			array('jquery','bootstrap.min','jquery.scrollUp.min','price-range','jquery.prettyPhoto'),
			$theme_version,
			true
		);
        ...
        wp_register_style(
            'price-range',
            get_template_directory_uri() . "/css/price-range.css"
        ...
        wp_register_style(
            ...
            array('tw-bootstrap','font-awesome','prettyPhoto','price-range','animate','responsive')
